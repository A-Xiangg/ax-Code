                        ...
                        <div class="list-item">
                            <div class="gd-item">
                                <div class="item" id="left1">
                                    ...
                                    <van-row>
                                        <van-col span="20"><div class="gdnum">
                                            <div class="gdnum-1">
                                                <dl>客户名称:</dl>
                                        ...
                                        <van-col span="4" >
                                            <div class="gb-item1">
                                                <van-button color="#606266" round type="info" plain  hairline  @click="editshow = true"size="mini"><span class="icon iconfont icon-shouquan1"/>授权</van-button>
                                            </div>
                                        </van-col>
                                    </van-row>
